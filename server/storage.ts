...
import { 
  adminUsers, pizzas, pizzaPrices, otpCodes, orders, orderItems, drivers, restaurants, customers, idempotencyKeys, telegramMessages, cashHandovers,
  ...
  type PizzaPrice, type InsertOrder, type Customer, type InsertCustomer, type CashHandover,

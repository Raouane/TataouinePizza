  ...
  return (
    <div className="space-y-12 pb-12">
      ...
      <section className="relative rounded-3xl overflow-hidden min-h-[60vh] flex items-end shadow-xl">
        ...
        <div className="relative z-10 p-6 md:p-12 w-full max-w-3xl">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold text-white mb-4 leading-tight animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-100">
            L'authentique goût <br />
            <span className="text-primary">du désert.</span>
          </h1>
          <p className="text-lg text-white/90 mb-8 max-w-lg animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
            Des ingrédients frais, une pâte artisanale et une livraison rapide dans tout Tataouine.
          </p>
          <Link href="/menu">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          { icon: Clock, title: "Livraison Rapide", desc: "Moins de 45 minutes chez vous." },
          { icon: ChefHat, title: "Faite Maison", desc: "Pâte pétrie chaque matin." },
          { icon: MapPin, title: "Local & Frais", desc: "Ingrédients du marché local." },
        ].map((feature, i) => (
      ...
      <section>
        <div className="flex justify-between items-end mb-8">
          <div>
            <h2 className="text-3xl font-serif font-bold mb-2">Nos Best-Sellers</h2>
            <p className="text-muted-foreground">Les favoris de nos clients cette semaine.</p>
          </div>
          <Link href="/menu">
             ...
             <Link key={i} href="/menu">
               <div className="group cursor-pointer">
                 <div className="aspect-square rounded-2xl overflow-hidden mb-4 relative">
                   ...
                   <div className="absolute bottom-3 right-3 bg-white/90 backdrop-blur px-3 py-1 rounded-full font-bold text-sm shadow-sm">
                     {item.price}
                   </div>
                 </div>
